...
estão o pedido deve ser atualizado para completo
E a resposta HTTP deve ser 200 OK

Cenário 8: Fazer um pedido com dados invalidos
Dado que todos os campos estão preenchidos com dados invalidos
E todos os campos string estão com dados do tipo integer
E todos os campos do tipo number estão com strings
Quando eu fazer uma requisição post para /api/Pedidos/post
estão o pedido nao deve ser salvo
...
estão o pedido deve ser atualizado para o status de done
E a resposta HTTP deve ser 200 OK